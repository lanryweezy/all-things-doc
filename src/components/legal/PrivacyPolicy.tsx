          ...
          <div className="prose prose-slate max-w-none">
            ...
            <section className="mb-8">
              ...
              <p className="text-slate-600 mb-4">
                ...
                transmit any personal information or document content to our servers.
              </p>
              <p className="text-slate-600">
                All document processing happens directly in your browser using client-side
                technologies. Your files never leave your device.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-slate-600 mb-4">
                When you use our tools, your documents are processed entirely in your browser. We
                use:
              </p>
            ...
            <section className="mb-8">
              ...
              <p className="text-slate-600 mb-4">
                Some AI-powered features may use third-party APIs (such as Google Gemini) for
            ...
            <section className="mb-8">
              ...
              <p className="text-slate-600 mb-4">We may use browser local storage to:</p>
              <ul className="list-disc pl-6 text-slate-600 space-y-2">
            ...
            <section className="mb-8">
              ...
              <p className="text-slate-600">We implement security measures to protect your data:</p>
              <ul className="list-disc pl-6 text-slate-600 space-y-2">
