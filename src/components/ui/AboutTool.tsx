          ...
          <section>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {features.map((f, i) => (
                <div
                  key={i}
                  className="flex items-center space-x-3 p-4 bg-white border border-slate-100 rounded-xl shadow-sm"
                >
          ...
          {seo?.h2 && (
            <section>
              ...
              <p className="text-slate-600 leading-relaxed">
                {tool.title} is designed for efficiency and simplicity. Whether you are a
                professional managing thousands of files or a casual user with a quick task, our
                platform provides the reliability and speed you need.
              </p>
            </section>
          )}
        </div>
        ...
        <div className="space-y-8">
          <div className="bg-slate-900 rounded-3xl p-8 text-white">
            ...
            <ul className="space-y-4 text-slate-300 text-sm">
              ...
              <li className="flex items-start">
                <span className="text-cyan-600 mr-2">✓</span>
                <span>
                  <strong>Privacy First:</strong> Most tools process data locally in your browser.
                </span>
              </li>
              <li className="flex items-start">
                <span className="text-cyan-600 mr-2">✓</span>
                <span>
                  <strong>AI-Powered:</strong> Advanced intelligence for complex documents.
                </span>
              </li>
              <li className="flex items-start">
                <span className="text-cyan-600 mr-2">✓</span>
                <span>
                  <strong>No Account:</strong> Start using tools instantly without signing up.
                </span>
              </li>
            </ul>
          </div>
          ...
          <div className="bg-indigo-50 border border-indigo-100 rounded-3xl p-8">
            ...
            <p className="text-indigo-700 text-sm mb-4">
              Explore our full suite of 40+ free productivity and developer tools.
            </p>
            <a href="/" className="inline-block text-indigo-600 font-bold hover:underline">
              View all tools →
            </a>
          </div>
        </div>
