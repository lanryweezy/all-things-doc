...
export const RegexTester: React.FC<RegexTesterProps> = ({ onBack }) => {
  ...
  const [testText, setTestText] = useState(
    'Contact us at support@allthingsdoc.com or info@example.org'
  );
          ...
          <div className="flex gap-4">
            <div className="flex-grow">
              ...
              <div className="relative">
                <div className="absolute left-3 top-1/2 -translate-y-1/2 text-slate-300 font-mono">
                  /
                </div>
                <input
                  value={regex}
                ...
                />
                <div className="absolute right-3 top-1/2 -translate-y-1/2 text-slate-300 font-mono">
                  /
                </div>
              </div>
            </div>
