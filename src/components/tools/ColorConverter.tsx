      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="flex flex-col">
          ...
          >
            ...
            <div
              className={`p-8 rounded-2xl backdrop-blur-md border ${parseInt(hex.replace('#', ''), 16) > 0xffffff / 2 ? 'bg-black/10 border-black/5 text-black' : 'bg-white/10 border-white/10 text-white'} text-center font-black text-2xl shadow-xl`}
            >
              {hex.toUpperCase()}
            </div>
          </div>
