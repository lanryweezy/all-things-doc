        ...
        {!file ? (
          ...
          <div className="space-y-8 animate-fade-in">
            <div className="flex justify-between items-center bg-slate-50 p-6 rounded-2xl border border-slate-100">
               ...
               <button onClick={reset} className="text-slate-400 hover:text-rose-500 font-bold text-sm flex items-center">
            ...
            {isProcessing ? (
              <div className="py-12 flex flex-col items-center justify-center space-y-4">
                 ...
                 <span className="text-sm font-bold text-slate-400 uppercase tracking-widest">Calculating Hashes...</span>
              </div>
            ) : hashes ? (
            ...
            <div className="bg-blue-50 p-6 rounded-2xl border border-blue-100 text-xs text-blue-800 leading-relaxed font-medium">
               Privacy Note: Files are never uploaded to any server. Hash calculation happens 100% locally in your browser using the Web Crypto API.
            </div>
            ...
            <div className="bg-indigo-50 p-4 rounded-xl border border-indigo-100 flex items-center justify-between">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-indigo-700 font-medium">Want to hash text instead of a file?</p>
                </div>
              </div>
              <button
