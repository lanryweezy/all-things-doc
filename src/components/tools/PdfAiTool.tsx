...
import { ProcessingProgress } from '../LoadingSpinner';
...
export const PdfAiTool: React.FC<PdfAiToolProps> = ({ toolId, onBack }) => {
  ...
  const getButtonText = () => {
    switch (toolId) {
      case ToolID.PDF_TO_EXCEL:
        return 'Convert to Excel/CSV';
      case ToolID.PDF_TO_POWERPOINT:
        return 'Generate Slide Outline';
      case ToolID.PDF_OCR:
        return 'Recognize Text';
      case ToolID.PDF_BANK_STATEMENT_CONVERTER:
        return 'Extract Bank Statement Data';
      default:
        ...
        {isProcessing && (
          <div className="mt-6">
            <ProcessingProgress
              progress={progress}
              message={
                toolId === ToolID.PDF_BANK_STATEMENT_CONVERTER
