          ...
          {error ? (
            ...
            <div className="space-y-6 animate-fade-in">
              ...
              <div className="p-6 bg-indigo-50 border border-indigo-100 rounded-3xl">
                ...
                <div className="text-xs text-indigo-700 font-medium">
                  The signature is cryptographically secure but cannot be "decoded" into
                  human-readable data. It is used to verify that the token hasn't been tampered
                  with.
                </div>
              </div>
            </div>
            ...
            <div className="h-full flex flex-col items-center justify-center text-slate-300 space-y-4 border-2 border-dashed border-slate-100 rounded-3xl p-12">
              ...
              <p className="text-center font-medium">
                Decoded content will appear here once you paste a valid JWT.
              </p>
            </div>
          )}
        </div>
      ...
      {decoded && (
        <div className="mt-12 grid grid-cols-1 md:grid-cols-2 gap-4 border-t border-slate-100 pt-8">
          <div
            ...
            onClick={() => (window.location.href = '/tools/password-strength')}
          >
          ...
          <div
            className="bg-slate-50 p-4 rounded-xl border border-slate-200 flex items-center justify-between group cursor-pointer hover:bg-slate-100 transition-colors"
            onClick={() => (window.location.href = '/tools/jwt-secret-generator')}
          >
            <div className="flex items-center space-x-3">
              <div className="p-2 bg-white rounded-lg shadow-sm">
