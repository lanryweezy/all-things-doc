            ...
            <div className="space-y-3">
              {results.map((res, i) => {
                ...
                return (
                  <div
                    key={i}
                    className={`flex items-center justify-between p-4 rounded-2xl border transition-all ${passes ? 'bg-emerald-50 border-emerald-100 text-emerald-800' : 'bg-rose-50 border-rose-100 text-rose-800'}`}
                  >
        ...
        <div className="space-y-6">
          <div className="bg-white rounded-3xl border border-slate-200 shadow-sm overflow-hidden flex flex-col min-h-[400px]">
            ...
            >
              ...
              <p className="max-w-xs text-lg font-medium leading-relaxed">
                This is a preview of how your chosen colors will look together for text and
                backgrounds.
              </p>
              <button
                className="px-8 py-3 rounded-full font-black text-sm uppercase tracking-widest border-4"
          ...
          <div className="bg-blue-50 p-6 rounded-2xl border border-blue-100 flex items-start space-x-4">
            ...
            <div className="text-xs text-blue-800 leading-relaxed font-medium">
              ...
              4.5:1 for normal text and 3:1 for large text to ensure content is readable for users
