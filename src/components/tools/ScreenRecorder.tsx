      ...
      <div className="bg-white rounded-3xl shadow-sm border border-slate-200 p-10">
        {!videoUrl ? (
          <div className="flex flex-col items-center justify-center text-center space-y-10 py-10">
            <div
              className={`w-32 h-32 rounded-full flex items-center justify-center transition-all duration-700 ${isRecording ? 'bg-rose-100 text-rose-600 animate-pulse' : 'bg-slate-100 text-slate-400'}`}
            >
              <Video size={64} />
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-slate-500 max-w-sm mx-auto">
                Record your entire screen, a window, or a specific browser tab. No software
                installation needed.
              </p>
            </div>
          ...
          <div className="space-y-8 animate-fade-in">
            ...
            <div className="flex justify-center space-x-4">
              <Button
                ...
                className="bg-emerald-600 px-10"
