...
export function updatePageSEO(toolId?: ToolID, additionalTitle?: string): void {
  ...
  // Update title
  const title = additionalTitle ? `${seoData.title} - ${additionalTitle}` : seoData.title;
...
export function setDefaultSEO(): void {
  ...
  const defaultDescription =
    'Transform your documents with All Things Doc - Free online PDF tools, AI-powered text processing, OCR, translation, and file conversion. No signup required.';
