...
export const ToolGrid: React.FC<ToolGridProps> = ({ onSelectTool }) => {
  ...
  const toolTips: Record<string, string> = {
    [ToolID.PDF_AI_SUMMARIZER]: "Uses AI to extract key insights and create concise summaries from PDF documents",
    [ToolID.PDF_BANK_STATEMENT_CONVERTER]: "AI-powered extraction of transaction data from bank statements into CSV format",
    [ToolID.PDF_OCR]: "Extracts text from scanned PDFs using Optical Character Recognition technology",
    [ToolID.PDF_MERGE]: "Combine multiple PDF files into a single document while maintaining quality",
    ...
    <div className="space-y-8">
      ...
      <div className="animate-fade-in min-h-[400px]">
        <div className="flex items-center space-x-4 mb-6 px-2">
            <h2 className="text-2xl font-bold text-doc-slate dark:text-white transition-colors">{activeCategory}</h2>
